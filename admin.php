...
add_filter( 'bulk_actions-edit', 'grunion_admin_bulk_actions' );
	...
	if ( is_array( $_POST['fields'] ) ) {
		...
		foreach ( $_POST['fields'] as $field ) {
			...
			if ( $field['required'] == 'true' )
				$req = ' required="true"';
			if ( $field['options'] )
				$opts = ' options="'.grunion_esc_attr( join(',', $field['options']) ).'"';
			$shortcode .= '[contact-field label="'.grunion_esc_attr($field['label']).'" type="'.grunion_esc_attr($field['type']).'"' . $req . $opts .' /]'."\n";
		}
	}
