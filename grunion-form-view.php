...
<script type="text/javascript" src="<?php echo GRUNION_PLUGIN_URL; ?>/js/jquery-ui-1.8.4.custom.min.js"></script>
...
<script type="text/javascript" src="<?php echo GRUNION_PLUGIN_URL; ?>/js/grunion.js"></script>
<script type="text/javascript">
...
<link type="text/css" href="<?php echo GRUNION_PLUGIN_URL; ?>ui-lightness/jquery-ui-1.8.4.custom.css" />
<style>
	/* Reset */
	html { height: 100%; }
	...
	.button { background-color:#FFFFFF; background:url("./wp-admin/images/white-grad.png") repeat-x scroll left top #F2F2F2; border-color:#BBBBBB; min-width:80px; text-align:center; color:#464646; text-shadow:0 1px 0 #FFFFFF; border-style:solid; border-width:1px; cursor:pointer; width: auto; font-size:11px !important; line-height:13px; padding:3px 11px; margin-top: 12px; text-decoration:none; -moz-border-radius:11px; border-radius:11px; -webkit-border-radius:11px }
	.button-primary { background-color:#FFFFFF; font-weight: bold; background: url('./wp-admin/images/button-grad-active.png') repeat-x scroll left top #21759B; border-color:#298CBA; min-width:80px; text-align:center; color:#EAF2FA; text-shadow:0 -1px 0 rgba(0, 0, 0, 0.3); border-style:solid; border-width:1px; cursor:pointer; width: auto; font-size:11px !important; line-height:13px; padding:3px 11px; margin-top: 21px; text-decoration:none; -moz-border-radius:11px; border-radius:11px; -webkit-border-radius:11px }
	.clear { clear: both; }
	...
	.fb-reorder:hover div { display: block !important; width: 110px; position: absolute; top: 0; right: 0; z-index: 200; padding: 5px 10px; color: #555; font-size: 11px; background: #FFF; border: 1px solid #CCC; -moz-border-radius:4px; border-radius:4px; -webkit-border-radius:4px; }
